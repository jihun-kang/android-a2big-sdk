 ...
 */
public class BannerBak extends RelativeLayout implements ViewPager.OnPageChangeListener{
...
//    List<Bitmap> ;
    ...
    public BannerBak(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHandler();
        init(context);
    }

    public BannerBak(Context context) {
        super(context);
        initHandler();
        init(context);
    ...
    public BannerBak(Context context, AttributeSet attrs, int defStyle) {
