...
public class RoundedImageView extends ImageView {
	...
	public interface onRoundedClickListener {
		public void onRoundedButtonClick(View v);
	 ...
	 */
	public void setOnRoundedClickListener(onRoundedClickListener onClickListener) {
	 ...
	 * 
	 */
	private onRoundedClickListener onClickListener;
	/**
	 * 
	 */
...
*/
		...
		if (handlerName != null) {
			setOnRoundedClickListener(new onRoundedClickListener() {
...
*/
		...
		DevLog.defaultLogging("RoundedImageView onDraw");
	...
	private void onTouchCircle(float x, float y, boolean up) {
		...
		if(up && BUTTON_PRESSED){
			...
			if(onClickListener!=null){
				this.setPressed(false);
				onClickListener.onRoundedButtonClick(this);
			}
		}
