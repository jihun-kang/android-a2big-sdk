 ...
 */
public class EndlessStaggeredGridView2 extends StaggeredGridView {
    ...
    public EndlessStaggeredGridView2(Context context) {
        super(context);
        init();

    }

    public EndlessStaggeredGridView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public EndlessStaggeredGridView2(Context context, AttributeSet attrs, int defStyle) {
